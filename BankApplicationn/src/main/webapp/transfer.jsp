...
<%@include file="header.jsp" %>
    ...
    <form class="Form" action="transfer" method="post" >
        <h1 class="h1">Transfer Here</h1>
        <div class="input">
        <label>Enter Receiver account number</label>
            <br>
            <input type="text" class="input1" name="receiver" placeholder="Enter account number" required>
            <br>
            <br>
            ...
            <br>
            <input type="text" class="input1" name="accno" placeholder="Enter account number" value="<%=c.getAccno()%>">
            <br>
            <br>
        ...
        <br>
        <input type="submit" value="Transfer" class=" btnn btn btn-primary" >
